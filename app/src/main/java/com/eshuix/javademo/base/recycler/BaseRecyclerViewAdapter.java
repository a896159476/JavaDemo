package com.eshuix.javademo.base.recycler;
...
import com.eshuix.javademo.base.recycler.animation.AlphaInAnimation;
import com.eshuix.javademo.base.recycler.animation.ScaleInAnimation;
import com.eshuix.javademo.base.recycler.animation.SlideInBottomAnimation;
import com.eshuix.javademo.base.recycler.animation.SlideInLeftAnimation;
import com.eshuix.javademo.base.recycler.animation.SlideInRightAnimation;
import com.eshuix.javademo.base.recycler.multi.BaseMultiItemEntity;
...
public abstract class BaseRecyclerViewAdapter<T,K extends BaseViewHolder> extends RecyclerView.Adapter<K>{
    ...
    //绑定数据的抽象方法
    abstract void convert(@NonNull K holder, T item, int position);
     ...
     * @param data item数据
     */
    protected BaseRecyclerViewAdapter(@NonNull List<BaseMultiItemEntity> data) {
        this(0, (List<T>) data);
        isMultiItem = true;
